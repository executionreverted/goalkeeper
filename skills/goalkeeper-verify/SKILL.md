...
1. Read `.goalkeeper/always-read.md`, `.goalkeeper/goal-contract.md`, `.goalkeeper/phase-plan.md`, `.goalkeeper/next-target.md`, `.goalkeeper/progress-log.md`, and `.goalkeeper/verification-log.md`.
...
7. Record exact evidence in `.goalkeeper/verification-log.md`.
8. Update statuses:
...
9. Mark a wave done only after all required steps pass.
10. Mark a phase done only after all required waves pass.
11. Refresh `.goalkeeper/resume-snapshot.md`.
12. Refresh `.goalkeeper/next-target.md`.
