...
12. Update `.goalkeeper/context-ledger.md`, the active scoped discovery step file, compact root indexes, and `.goalkeeper/resume-snapshot.md` after each meaningful answer.
