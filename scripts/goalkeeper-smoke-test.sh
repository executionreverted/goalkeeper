...
expect_contains "$ROOT_DIR/skills/goalkeeper-new-project/SKILL.md" ".goalkeeper/policies/*.md"
...
expect_contains "$ROOT_DIR/skills/goalkeeper-loop/SKILL.md" ".goalkeeper/policies/*.md"
...
expect_contains "$ROOT_DIR/skills/goalkeeper-execute/SKILL.md" ".goalkeeper/policies/tool-policy.md"
expect_contains "$ROOT_DIR/skills/goalkeeper-execute/SKILL.md" ".goalkeeper/policies/subagent-policy.md"
expect_contains "$ROOT_DIR/skills/goalkeeper-plan/SKILL.md" ".goalkeeper/policies/parallelization.md"
...
expect_contains "$TMP_DIR/init.out" "write: .goalkeeper/policies/tool-policy.md"
expect_contains "$TMP_DIR/init.out" "write: .goalkeeper/policies/subagent-policy.md"
expect_contains "$TMP_DIR/init.out" "write: .goalkeeper/policies/parallelization.md"
...
expect_contains "$TMP_DIR/validate-init.out" "OK policies/tool-policy.md"
expect_contains "$TMP_DIR/validate-init.out" "OK policies/subagent-policy.md"
expect_contains "$TMP_DIR/validate-init.out" "OK policies/parallelization.md"
rm "$TMP_DIR/.goalkeeper/policies/tool-policy.md"
expect_fails "$TMP_DIR/validate-missing-policy.out" "$ROOT_DIR/scripts/goalkeeper-validate.sh" "$TMP_DIR"
expect_contains "$TMP_DIR/validate-missing-policy.out" "FAIL missing policies/tool-policy.md"
"$ROOT_DIR/scripts/goalkeeper-init.sh" "$TMP_DIR" >"$TMP_DIR/init-repair.out"
expect_contains "$TMP_DIR/init-repair.out" "write: .goalkeeper/policies/tool-policy.md"
"$ROOT_DIR/scripts/goalkeeper-validate.sh" "$TMP_DIR" >"$TMP_DIR/validate-repaired-policy.out"
expect_contains "$TMP_DIR/validate-repaired-policy.out" "OK policies/tool-policy.md"
